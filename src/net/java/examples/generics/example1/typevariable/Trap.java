...
public class Trap<T> {
  ...
  public Trap(T trapped) {
    System.out.println("Trap constructor, caught a " + trapped.getClass().getSimpleName());
  ...
  static {
    ...
    // System.out.println("Trap the static init 2 : " + trapped.getClass().getSimpleName());
...
//     allTrappedByThisInstance = new ArrayList<T>();
...

  {
    ...
    if (trapped != null) {
      // NOTE: 'trapped' is impossible to initialise by the point that this
      // instance initialiser gets
      // called because instance initialisers are called AFTER super() ones, but
    ...
    allTrappedByThisInstance = new ArrayList<T>();
    System.out.println("Trap instance initialser 3 : Created list to hold all trapped");
  }
